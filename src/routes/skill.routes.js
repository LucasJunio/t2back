...
router.put('/:id', async (req, res) => {
    ...
    await DeparSkilltment.findByIdAndUpdate(req.params.id, newSkill);    
...
router.delete('/:id', async (req, res) => {
    ...
    const skillusersublevel = await SkillUserSublevel.findOne({ skill: req.params._id });
    ...
    await Skill.findByIdAndDelete(req.params._id);
